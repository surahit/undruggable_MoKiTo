...
def random_search(X, Y, NN_layers, learning_rates, weight_decays, batch_size=50, search_iterations=20):
...
def power_method(pt_x0, pt_xt, f_NN, scale_and_shift, Niters = 500, Nepochs = 10, tolerance  = 5e-3, batch_size = 50, 
    ...
    for i in loop:
        ...
        train_loss, val_loss, best_loss = trainNN(net = f_NN, lr = lr, wd = wd, Nepochs = Nepochs, batch_size=batch_size, X=pt_x0, Y=pt_y)
